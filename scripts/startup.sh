#!/bin/ash
if [ -z "$ENVIRONMENT" ] then echo "ENVIRONMENT is unset"; else echo "ENVIRONMENT is set to '$ENVIRONMENT'"; fi
if [ -z "$KC_HMAC_SECRET_KEY_HEX" ] then echo "KC_HMAC_SECRET_KEY_HEX is unset"; else echo "KC_HMAC_SECRET_KEY_HEX is set"; fi
if [ -z "$KC_PRIVATE_KEY" ] then echo "KC_PRIVATE_KEY is unset"; else echo "KC_PRIVATE_KEY is set"; fi
if [ -z "$DATABASE_HOST" ] then echo "DATABASE_HOST is unset"; else echo "DATABASE_HOST is set"; fi
if [ -z "$DATABASE_PORT" ] then echo "DATABASE_PORT is unset"; else echo "DATABASE_PORT is set"; fi
