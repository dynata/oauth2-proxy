...
func Validate(o *options.Options) error {
	...
	var redirectV2URL *url.URL
	redirectV2URL, msgs = parseURL(o.RawRedirectV2URL, "redirect", msgs)
	o.SetRedirectV2URL(redirectV2URL)
	...
	allClientIds := []string{o.GetProvider().Data().ClientID}
	for clientId := range o.GetProvider().Data().Clients {
		allClientIds = append(allClientIds, clientId)
	}
	o.SetAllClientIDs(allClientIds)
