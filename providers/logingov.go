...
func (p *LoginGovProvider) GetLoginURL(ctx context.Context, redirectURI, state, _ string) string {
	...
	a := makeLoginURL(ctx, p.ProviderData, redirectURI, state, extraParams)
	return a.String()
}
